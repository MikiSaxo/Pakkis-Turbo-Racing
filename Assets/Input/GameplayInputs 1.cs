...
//     version 1.6.3
//     from Assets/Input/GameplayInputs 1.inputactions
//
...
public partial class @GameplayInputs1: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @GameplayInputs1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""GameplayInputs 1"",
    ""maps"": [
        {
            ""name"": ""Boat"",
    ...
    {
        private @GameplayInputs1 m_Wrapper;
        public BoatActions(@GameplayInputs1 wrapper) { m_Wrapper = wrapper; }
